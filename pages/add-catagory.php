...
// fetching all data from category table where userid matches the current logged in user's id
$category = mysqli_query($con, "SELECT * from category where userid=$user_id");

// fetching the businessname of the current logged in user from the user table
$businessname = mysqli_query($con, "SELECT  businessname  FROM user  where id='$user_id'");

// storing the business name in a variable for later use
                ...
                <div class="container p-0 ">
                    ...
                    <div class="container">
                        <table class="table text-darkBlue table-sm ">
                            <!-- this gets the category from the user-->
                            <thead>
                                <tr>
                            ...
                            while ($m = mysqli_fetch_array($category)) {
                                //two buttons one is for editing the other is for deleting
                                echo '<tr>';
