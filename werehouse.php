                    ...
                    <div class="form-group row ">
                        <div class="col-md-6 ">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingInput1" name="productname" placeholder="lang-tag='entername'">
                                <label for="floatingInput1" lang-tag="entername"></label>
                            </div>
                        </div>
                        <div class="col-md-6  ">
                            <div class="form-floating mb-3 ">
                                <input type="number" class="form-control" id="floatingInput" min="1" name="productquantity" placeholder="lang-tag=' enterQuantity'">
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            <div class="form-floating">
                                ...
                                <label for="floatingSelect" lang-tag="entercatname">/label>
                            </div>
                        </div>
                        <div class="col-md-6 ">
                            <div class="form-floating ">
                ...
                <table class="table text-darkBlue" id="werehouseTable">
                    ...
                    if (isset($sql)) {
                        while ($r = mysqli_fetch_array($sql)) {
                            ...
                            echo '<td>' . $r['cost'] . '</td>';
                            echo '<td>' . $r['j'] . '</td>';
                            echo '<form action="editwarehouse.php"method="get"><td class="text-center">
                            <a href="editwarehouse.php?edit=' . $r['id'] . '" class="btn btn-lightPurple btn-sm"   ><i class="fa-regular fa-pen-to-square"></i></a>
                    </td>';
                            echo '<td class="text-center"> 
                            <a href="editwarehouse.php?del=' . $r['id'] . '" class="btn btn-lightPurple btn-sm"  ><i class="fa-solid fa-trash-can"></i></a>
                    </td></form> 
                    </tr>';
                        }
                    } else {
                        while ($m = mysqli_fetch_assoc($query)) {
                            ...
                            echo '<td>' . $m['caname'] . '</td>';
                            echo '<form action="editwarehouse.php"method="get"><td class="text-center">
                                <a href="editwarehouse.php?edit=' . $m['id'] . '" class="btn btn-lightPurple btn-sm"  ><i class="fa-regular fa-pen-to-square"></i></a>
                        </td>';
                            echo '<td class="text-center">
                            <a href="editwarehouse.php?del=' . $m['id'] . '"class="btn btn-lightPurple btn-sm"  ><i class="fa-solid fa-trash-can"></i></a>
                        </td></form> 
                        </tr>';
                        }
                    }
